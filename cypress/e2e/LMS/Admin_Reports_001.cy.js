...
describe('Validate Admin Edited the Gradebook Template Successfully',function(){
    ...
    it('Verify that School Admin can Edit the TopSchool Gradebook Template',function(){
        ...
        //ReportDashboardPage.getAdminReportsGradeEditButton("Grade 2").click()
      ...
      ReportDashboardPage.getVerifyGradeContainPublishedStatus("Grade 2").should('have.text','Published')
      ReportDashboardPage.getPublishedStatusToggleButton("Grade 2").click()
      cy.wait(1000)
     ...
     // ReportDashboardPage.getVerifyGradebookUnfinishedSuccesfullyTxt().should('have.contains',' Gradebook is unpublished successfully')
      ReportDashboardPage.getVerifyGradeContainDraftStatus("Grade 2").should('have.text','Draft')
      ReportDashboardPage.getDraftStatusToggleButton("Grade 2").click()
      ReportDashboardPage.getPreviewScreenPublishButton().click()
      ReportDashboardPage.getPreviewScreenYesPublishButton().click()
      ReportDashboardPage.getVerifyGradeContainPublishedStatus("Grade 2").should('have.text','Published')
      ReportDashboardPage.getPublishedStatusToggleButton("Grade 2").click()
      ...
      ReportDashboardPage.getDeleteButton("Grade 2").click()
